		...
		<main>
			<div class="jumbotron">
				<div class="jumbotron-text">
					<h1>Selamat datang rental PS Jelmi</h1>
					<p> Menyediakan lebih dari 40 PS Yang siap dimainkan
					</p>
					<button type="button" class="btn_getStarted">Get Started</button>
				</div>
				<div class="jumbotron-img">
					<img src="assets/maenPS.jpg" alt="" style="width: 500px; padding: 10px" />
				</div>
			</div>
			<div class="cards-categories">
				<h2>harga Sewa yang kami tawarkan mulai dari</h2>
				<h2>PS3: Rp 50.000</h2>
				<h2>PS4: Rp 75.000</h2>
				<h2>PS5: Rp 100.000</h2>
